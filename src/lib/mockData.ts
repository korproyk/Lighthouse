...
export const challenges: Challenge[] = [
  {
    id: 'core-sleep',
    title: "Tonight's Sleep Goal",
    description: 'Recharge your body and mind tonight.',
  ...
  },
  {
    ...
    description: 'Read anything offline for twenty focused minutes.',
    instructions: 'Pick a book, magazine, or paper notes. Read for 20 minutes with screens away. Photo your page or cover when you finish.',
    difficulty: 'easy',
    pack: 'worldwide',
    flag: '\u{1F30D}',
    timeEstimate: '20 min',
  ...
  },
  {
    ...
    description: 'Sketch a simple plan for the next seven days.',
    instructions: 'Write 3 priorities and one rest block for the week ahead. Keep it light. Photo your plan when done.',
    difficulty: 'easy',
    pack: 'worldwide',
    flag: '\u{1F30D}',
    timeEstimate: '15 min',
  ...
  {
    id: 'ww-7',
    title: 'No YouTube Tonight',
    description: 'Skip YouTube for the rest of the evening.',
    instructions: 'From now until bedtime, do not open YouTube. Do something analog instead. Photo your evening setup without the app open.',
    difficulty: 'medium',
    pack: 'worldwide',
    flag: '\u{1F30D}',
  ...
  },
  {
    ...
    description: 'Be in bed with lights down before 11 tonight.',
    instructions: 'Set a wind-down alarm. Be in bed before 11 PM with screens away. Photo your clock or dim room as proof.',
    difficulty: 'medium',
    pack: 'worldwide',
    flag: '\u{1F30D}',
    timeEstimate: 'Tonight',
  ...
  },
  {
    ...
    instructions: 'On paper or in notes, list three specific things you appreciate today. Keep each to one line. Photo the list when done.',
    difficulty: 'easy',
    pack: 'worldwide',
    flag: '\u{1F30D}',
    timeEstimate: '10 min',
